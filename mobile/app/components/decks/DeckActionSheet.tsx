...
export default function DeckActionSheet({
  ...
  const handleDeletePress = () => {
    ...
    Alert.alert(
      t("decks.actions.deleteTitle", "Supprimer le deck"),
      t("decks.actions.deleteMessage", {
        name: deck.name,
      ...
      [
        ...
        },
        {
          ...
          style: "destructive",
          onPress: () => deleteMutation.mutate(deck.id),
        },
      ],
    );
  };
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ color: "#6e9e8a", fontSize: 12, marginTop: 2 }}>
                  {deck.cardCount}{" "}
                  {deck.cardCount > 1
